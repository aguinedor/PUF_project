...
architecture GTM_DUAL_V of GTM_DUAL is
  ...
  constant SIM_RESET_SPEEDUP_TRUE : std_ulogic := '1';
  constant SIM_RESET_SPEEDUP_FALSE : std_ulogic := '0';
...
-- Parameter encodings and registers
  ...
  signal SIM_RESET_SPEEDUP_BIN : std_ulogic;
  signal RST_CFG_BIN : std_logic_vector(15 downto 0);
  ...
  SIM_RESET_SPEEDUP_BIN <= 
      SIM_RESET_SPEEDUP_FALSE when (SIM_RESET_SPEEDUP = "FALSE") else
      SIM_RESET_SPEEDUP_TRUE when (SIM_RESET_SPEEDUP = "TRUE") else
      SIM_RESET_SPEEDUP_FALSE;

  RST_CFG_BIN <= RST_CFG(15 downto 1) & SIM_RESET_SPEEDUP_BIN;
  ...
  begin
    ...
    -------- SIM_RESET_SPEEDUP check
      if((xil_attr_test) or
        ...
        Write ( Message, string'("Error : [Unisim "));
        Write ( Message, string'(MODULE_NAME));
        Write ( Message, string'("-462] SIM_RESET_SPEEDUP attribute is set to """));
    ...
    -------- TX_AMPLITUDE_SWING check
        if((xil_attr_test) or
          ...
          Write ( Message, string'("Error : [Unisim "));
          Write ( Message, string'(MODULE_NAME));
          Write ( Message, string'("-463] TX_AMPLITUDE_SWING attribute is set to "));
