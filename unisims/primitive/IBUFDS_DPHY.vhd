...
-- Parameter encodings and registers
  ...
  if((xil_attr_test) or
    ...
    Write ( Message, DIFF_TERM);
    Write ( Message, string'(". Legal values for this attribute are ULTRASCALE_PLUS or ULTRASCALE_PLUS_ES1 or ULTRASCALE_PLUS_ES2 or VERSAL or VERSAL_ES1 or VERSAL_ES2. "));
    Write ( Message, string'("Instance "));
    Write ( Message, string'(IBUFDS_DPHY_V'PATH_NAME));
    writeline(output, Message);
    DEALLOCATE (Message);
