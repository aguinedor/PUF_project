...
-- Parameter encodings and registers
  constant SIM_DEVICE_EVEREST : std_logic_vector(3 downto 0) := "0001";
  constant SIM_DEVICE_EVEREST_ES1 : std_logic_vector(3 downto 0) := "0010";
  constant SIM_DEVICE_EVEREST_ES2 : std_logic_vector(3 downto 0) := "0011";
  constant SIM_DEVICE_ULTRASCALE : std_logic_vector(3 downto 0) := "0000";
  constant SIM_DEVICE_ULTRASCALE_PLUS : std_logic_vector(3 downto 0) := "0100";
  constant SIM_DEVICE_ULTRASCALE_PLUS_ES1 : std_logic_vector(3 downto 0) := "0101";
  constant SIM_DEVICE_ULTRASCALE_PLUS_ES2 : std_logic_vector(3 downto 0) := "0110";
  constant SIM_DEVICE_VERSAL : std_logic_vector(3 downto 0) := "0111";
  constant SIM_DEVICE_VERSAL_ES1 : std_logic_vector(3 downto 0) := "1000";
  constant SIM_DEVICE_VERSAL_ES2 : std_logic_vector(3 downto 0) := "1001";

  signal IS_C_INVERTED_BIN : std_ulogic;
  signal IS_D1_INVERTED_BIN : std_ulogic;
  signal IS_D2_INVERTED_BIN : std_ulogic;
  signal SIM_DEVICE_BIN : std_logic_vector(3 downto 0);
  ...
  SIM_DEVICE_BIN <= 
      ...
      SIM_DEVICE_EVEREST when (SIM_DEVICE = "EVEREST") else
      SIM_DEVICE_EVEREST_ES1 when (SIM_DEVICE = "EVEREST_ES1") else
      SIM_DEVICE_EVEREST_ES2 when (SIM_DEVICE = "EVEREST_ES2") else
...
-- begin behavioral model
  ...
  begin
    if ((SIM_DEVICE /= "EVEREST") or (SIM_DEVICE /= "EVEREST_ES1") or (SIM_DEVICE /= "EVEREST_ES2") or (SIM_DEVICE /= "VERSAL") or (SIM_DEVICE /= "VERSAL_ES1") or (SIM_DEVICE /= "VERSAL_ES2")) then
      R_sync <= SR;
    else
